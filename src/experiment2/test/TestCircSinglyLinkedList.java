...
import experiment2.CircSinglyLinkedList;

public class TestCircSinglyLinkedList {

	public static void main(String[] args) {
		CircSinglyLinkedList<Integer> list = new CircSinglyLinkedList<Integer>();
		System.out.println("循环单链表已构建：");
		for(int i = 1;i <= 5;i++)
			list.insert(i-1,new Integer(i));
